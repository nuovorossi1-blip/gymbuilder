...
- [ ] Verificare su telefono reale (o almeno con un utente autenticato) i badge Top Set/Back-Off/FST-7 e il messaggio alternato FST-7 in Runner.tsx (19/08): verificato in browser desktop via Playwright su `/avvia` (bypassa l'auth), non ancora su un allenamento generato davvero da Create.tsx con protocollo scelto dal wizard.
