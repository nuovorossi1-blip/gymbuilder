...
| 2026-08-12 | Antigravity | Clonata la repo locale, risolta la regressione temporale nei test di `weakPoints` con parametro `referenceDate` opzionale, risolti i 3 warning ESLint Fast Refresh in `eslint.config.js` e `WorkoutPreview.tsx`. 188 test verdi, build Vite OK, ESLint 0 errori/warning. |
