...
| 2026-08-06 | Codex | Correzione PPL con vincoli movement pattern, Profile contract `user_id` + migration RLS e Timer/Audio Engine unificato a timestamp. 149 test e build verdi; applicazione migration e verifica mobile/produzione da completare nel rilascio. |
